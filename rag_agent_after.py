...
from retrievers_after import get_hybrid_retriever_after
...
def retrieve_node(state: GraphState) -> GraphState:
    retriever = get_hybrid_retriever_after(k_dense=6, k_bm25=6)
...
def ask_after(question: str) -> GraphState:
    return GRAPH.invoke(
        {"question": question, "use_web": False, "retrieved_docs": [], "web_snippets": "", "answer": ""}
    )